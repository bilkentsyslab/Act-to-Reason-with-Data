from common import DEF_LANE_WIDTH, DEF_LANE_LENGTH, BASE_OFFSET
from common import fill_rectangle_scaled, draw_line_scaled

from common import ROAD_LEN, MERGE_START, MERGE_END, RAMP_START, CAR_LEN
